...
var _floatToInteger = _interopRequireDefault(require("./floatToInteger.js"));
...
function getColumnWidthInCharacters(columnWidthInPixels) {
  ...
  var characterWidth = (0, _floatToInteger["default"])((columnWidthInPixels - 5) / maximumDigitWidth * 100 + 0.5) / 100; // To translate from character width to real width, use this calculation:
  // =Truncate([{Number of Characters} * {Maximum Digit Width} + {5 pixel padding}]/{Maximum Digit Width}*256)/256

  return (0, _floatToInteger["default"])((characterWidth * maximumDigitWidth + 5) / maximumDigitWidth * 256) / 256;
}
