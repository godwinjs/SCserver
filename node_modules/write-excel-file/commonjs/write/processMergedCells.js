...
exports["default"] = processMergedCells;

var _getCellStyleProperties = _interopRequireDefault(require("./getCellStyleProperties.js"));
...
function processMergedCells(data, _ref) {
  ...
  var _cloneData = function cloneData() {
    ...
    data = data.slice(); // Also clone each row of `data`.
...
function processSpanningCells(_ref2) {
  ...
  var cellStyleProperties = (0, _getCellStyleProperties["default"])(data[rowIndex][columnIndex]);
