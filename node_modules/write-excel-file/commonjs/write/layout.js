...
exports["default"] = generateLayout;
...
function generateLayout(_ref) {
  ...
  var layout = ''; // Margins are required when setting custom orientation,
  ...
  if (orientation) {
    ...
    //
    var paperSize = 9; // Page orientation (when printing).
    //
    // `orientation` can be:
    // * `landscape`
    // * `portrait`
    ...
    layout += " orientation=\"".concat((0, _sanitizeAttributeValue["default"])(orientation), "\"");
